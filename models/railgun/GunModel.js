...
export function createTurretGun(scene) {
  ...
  const baseMount = BABYLON.MeshBuilder.CreateCylinder(
    "baseMount",
    {
      height: 0.3,
      diameter: 1.2,
  ...
  const mainBody = BABYLON.MeshBuilder.CreateCylinder(
    "mainBody",
    {
      height: 0.6,
      diameter: 0.8,
  ...
  createArmorPlate(
    "leftArmor",
    new BABYLON.Vector3(-0.35, 0.1, 0),
  ...
  const mainBarrel = BABYLON.MeshBuilder.CreateCylinder(
    "mainBarrel",
    {
      height: 2.5,
      diameter: 0.25,
